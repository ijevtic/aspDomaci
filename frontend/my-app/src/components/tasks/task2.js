...
const body = (
    <>
        ...
        <PStyled>Potrebno je napraviti program za komandnu liniju u jeziku po izboru u 
            kom treba da omogućite prikaz AVL stabla nakon dodavanja/brisanja čvorova. 
            Izgled AVL stabla potrebno je prikazati nakon svake rotacije(LL,LR,RL,RR). Potrebno je da se čvorovi i veze
            jasno vide u konzoli nakon svakog ispisa. Način prikaza se ostavlja studentima.
        </PStyled>
